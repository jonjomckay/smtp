...
import com.jonjomckay.mail.smtp.handlers.*;
import com.jonjomckay.mail.smtp.storage.MaildirMessageStore;
...
public class SmtpVerticle extends AbstractVerticle {
    private final static Logger LOGGER = LoggerFactory.getLogger(SmtpVerticle.class);
    ...
    public void start(Promise<Void> startPromise) {
        ...
        netServer.connectHandler(socket -> {
            ...
            socket.handler(fullMessage -> {
                ...
                if (dataCommand.get()) {
                    ...
                    if (message.endsWith("\r\n.\r\n")) {
                        ...
                        smtpHandler.writeResponse(new SmtpResponse(250, "OK: Queued as 12345"));
                    ...
                    switch (command) {
                        ...
                        default:
                            ...
                            smtpHandler.writeResponse(new SmtpResponse(502, "Unsupported command"));
                            break;
                    }
                }
            });
            ...
            smtpHandler.writeResponse(new SmtpResponse(220, "Ready"));
        });
